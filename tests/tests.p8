...
function run_tests()
    ...
    assert_equal(cos(0.5),   0xffff0000, "cos(0.5)")
    assert_equal(cos(0.625), 0xffff4afb, "cos(0.625)")
    assert_equal(cos(0.75),  0x00000000, "cos(0.75)")
    assert_equal(cos(0.875), 0x0000b505, "cos(0.875)")
    assert_equal(cos(1),     0x00010000, "cos(1)")
    ...
    assert_equal(sin(0.25),  0xffff0000, "sin(0.25)")
    assert_equal(sin(0.375), 0xffff4afb, "sin(0.375)")
    assert_equal(sin(0.5),   0x00000000, "sin(0.5)")
    assert_equal(sin(0.625), 0x0000b505, "sin(0.625)")
    assert_equal(sin(0.75),  0x00010000, "sin(0.75)")
    assert_equal(sin(0.875), 0x0000b505, "sin(0.875)")
    assert_equal(sin(1),     0x00000000, "sin(1)")
